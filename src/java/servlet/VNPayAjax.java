...
import static servlet.Config.vnp_Command;
import static servlet.Config.vnp_Version;
...
public class VNPayAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet VNPayAjax</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet VNPayAjax at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Cart> carts = myCartDAO.getListCartByCustomerID(customer.getCustomer_id());
            String date = java.time.LocalDate.now().toString();
            int amount = (Integer) request.getAttribute("cartTotal");
            Order newOrder = new Order(customer.getCustomer_id(), date, amount, "Pending", 1, "Reivew");
...
//        paymentRestDTO.setMessage("Sussessfully");
