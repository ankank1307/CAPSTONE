...
<html>
    ...
    <body>
        <% Staff tempStaff = (Staff) request.getAttribute("staff");%>
        <div class="wrapper bg-white mt-sm-5">
            ...
            <div class=" image d-flex flex-column justify-content-center align-items-center">      
                ...
                <span class="name mt-3">@<%=tempStaff.getUsername()%></span> 
            </div>
            ...
            <div class="py-2">
                <form action="LoginServlet?mode=changePasswordStaff&staffID=<%=tempStaff.getStaff_id()%>" method="POST">
                    ...
                    <div class="py-3 pb-4 border-bottom">
                        ...
                        <a href="staffLogin.jsp"><button type="button" class="btn border button">Cancel</button></a>
                    </div>
                </form>
            </div>
        </div>
