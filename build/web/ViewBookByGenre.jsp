...
<html lang="en">
    ...
    <%
        ArrayList<Book> listBook = (ArrayList<Book>) request.getAttribute("listGenreBook");
                    ...
                    <div class="col-md-12">			
                        <div class="colored">
                            ...
                            <div class="breadcum-items">
                                ...
                                <span class="item colored">Books in <%=myGenreDAO.getGenreByID(listBook.get(0).getGenre_id()).getGenre()%></span>
                            </div>
                        </div>
                    </div>
                </div>
