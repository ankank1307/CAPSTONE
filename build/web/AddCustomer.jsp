            ...
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto h-100">
                        <li class="nav-item">
                            <a class="nav-link active" href="StaffManageBookServlet?mode=staffViewBook">
                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        ...
                        <div class="row tm-edit-product-row">
                            <div class="col-xl-6 col-lg-6 col-md-10" id="add">
                                <form action="AddCustomerServlet" method="post" class="tm-edit-product-form">
...
<!--                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3 ">
                                        <label for="expire_date"> Password </label>
                                        <input id="expire_date" name="password"  value="123456" class="form-control validate" data-large-mode="true" readonly=""/>
                                    </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                                <div class="form-group mb-3">
                                        ...
                                        <input
                                            ...
                                            id="name" name="address" class="form-control validate" required=""/>
                                    </div>
                                <div class="form-group mb-3">
                                        <label  for="name" >Email</label>
                                        <input
                                            
                                            id="name" name="email" class="form-control validate" required=""/>
                                    </div>
...
<!--                                <div class="custom-file mt-3 mb-3">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-block text-uppercase">ADD NEW CUSTOMER</button>
                            </div>
                            </form>
