                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="main-slider pattern-overlay" style="padding: 0px;">
                            <%
                                // Sort the list of books by publication date or any other criterion
                                Collections.sort(listBook, Comparator.comparing(Book::getBook_id).reversed());

                                // Iterate over the first two books (the two latest)
                                for (int i = 0; i < Math.min(listBook.size(), 2); i++) {
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <%
// Sort the list of books by quantity in descending order
                            Collections.sort(listBook, Comparator.comparingInt(Book::getQuantity).reversed());
                        ...
                        <div class="product-list" data-aos="fade-up">
                            <div class="row">
                                <% for (int i = 0; i < Math.min(listBook.size(), 4); i++) {%>
                                <div class="col-md-3">
