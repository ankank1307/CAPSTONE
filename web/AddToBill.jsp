                        ...
                        <div class="tm-product-table-container " style="margin-top: 25px">
                            <table class="table table-hover tm-table-small tm-product-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td><img src="" style="max-width: 100%;width: 115px;height: 115px;" alt="loading"> </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                            ...
                            <p style="color: white; font-size: 26px;margin-left: 780px">Total: </p>
                            <a href="" style="margin-top: 30px" class="btn btn-primary btn-block text-uppercase mb-3">Payment</a>
